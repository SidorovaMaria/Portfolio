import { Coffee, PenTool, NotebookPen, Lightbulb, Code } from "lucide-react";
export const heroTags = [
  { text: "Sketches", icon: NotebookPen },
  { text: "Ideas", icon: Lightbulb },
  { text: "Code", icon: Code },
  { text: "Design", icon: PenTool },
...
export const projects = [
  ...
  },
  {
    ...
    description:
      "A simple budget tracker web app built with React, TailwindCSS, and Redux for state management.",
    tags: ["Vite", "React", "Redux", "TailwindCSS", "Motion"],
